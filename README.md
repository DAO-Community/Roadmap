...
# DAO Community public roadmap

:sparkle: View the [official DAO Community public product roadmap](https://github.com/orgs/DAO-Community/projects/3)

Our product roadmap is where you can learn about what features we're working on, what stage they're in, and when we expect to bring them to you. Have any questions or comments about items on the roadmap? Share your feedback via [DAO Community public feedback discussions](https://github.com/DAO-Community/feedback/discussions). 

The roadmap repository is for communicating DAO Community’s roadmap. Existing issues are currently read-only, and we are locking conversations, as we get started. Interaction limits are also in place to ensure issues originate from DAO Community. We’re planning to iterate on the format of the roadmap itself, and we see potential to engage more in discussions about the future of DAO Community projects and events. If you have feedback about this roadmap repository itself, such as how the issues are presented, let us know through [general feedback in DAO Community public feedback discussions](https://github.com/DAO-Community/feedback/discussions/new?category=General-Feedback&title=[Public%20roadmap]%20).
